...
!(function (e, t) {
  ...
  function F(r, n) {
    function Uc(e) {
      if (e || 0 === e) {
        ...
        (e = Uc.v = Math.round(e) || (ze && ze.iOS ? 1 : 0)),
          r(e),
          (Uc.cacheID = k.cache),
          t && o("ss", e);
      ...
      (te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), B(Y ? n : ve, De[1], Ve, !0)),
  ...
  var We,
    ...
    X = { top: 0, left: 0, center: 0.5, bottom: 1, right: 1 },
        ...
        if (
          ...
          if (
            ...
            (e = Ka(u) ? fb(u, At) : At),
              ...
              (z = ub("scroller-end", a, ve, ge, e, 0, B)),
              (t = B["offset" + ge.op.d2]);
            ...
            (P = this.markerStart = ub("start", a, f, ge, e, t, 0, fe)),
              ...
              me ||
                ...
                We.set([B, z], { force3D: !0 }),
                (x = We.quickSetter(B, ge.a, kt)),
                (w = We.quickSetter(z, ge.a, kt)));
          }
          if (fe) {
                ...
                if (ie && e && pt) nb(ScrollTrigger, "scrollEnd", Jb);
                  ...
                  if (
                    ...
                    (r = db(ie)),
                      ...
                      (c = me && J(ve, o ? Re : Ne)()),
                      oe &&
                        (((U = [oe + ge.os2, D + v + kt]).t = L),
                        (S = oe === St ? hb(ie, ge) + D + v : 0) &&
                          U.push(ge.d, S + kt),
                        It(U),
                        me && Ce(q)),
                      me &&
                  ...
                  f &&
                    ...
                    Se.revert(!1),
                    j &&
                      ((Me = -1), Se.isActive && Ce(C + D * Q), j.restart(!0)),
                    (rt = 0),
                    T &&
                      he &&
                      (T._initted || G) &&
  ...
  function qc(e) {
    ...
    function tp() {
      (h._gsap.y = ya(parseFloat(h._gsap.y) + v.offset) + "px"),
        (h.style.transform =
    ...
    return (
      ...
      (e.onPress = function () {
        var e = m;
        (m = ya(((je.visualViewport && je.visualViewport.scale) || 1) / y)),
          a.pause(),
          e !== m && jc(d, 1.01 < m || (!f && "x")),
          (c = b()),
          (u = v()),
        ...
        function (e, t) {
          if ((v.offset && tp(), t)) {
            ...
            f &&
              ...
              ((P && a.vars.scrollY >= o) || o - 1 <= r) &&
                We.to({}, { onUpdate: zp, duration: i });
          } else s.restart(!0);
        }),
      (e.onWheel = function () {
